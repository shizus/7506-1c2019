...
\subsection{Clicks}
	...
	\subsubsection{Clicks en los dias y horas}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=\textwidth]{images/clicks/clicks_source_id_hours_persentage.png}
	...
	\subsubsection{Clicks en la pantalla del dispositivo}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=\textwidth]{images/clicks/clicks_touch_heat.png}
			\caption{Posicion del click en pantalla}
		\end{figure}
		\FloatBarrier
	...
	\subsubsection{Tiempo en realizar el click}
		...
		\tab Se nos ocurrió analzar el promedio de tiempo que tarda una persona en realizar click. Primero decidimos filtrar los clicks en el que la persona tardaba mas de 10 minutos en hacer click. Esto lo hicimos debido a que habia clicks que tardaban más de un año en realizarse y supucimos que es un error en los datos. Llegamos a que una persona tarda 55.5921630859375 segundos en promedio en tocar click.

	
		\tab En los siguietes gráficos se mostrará la distribución en el tiempo que tardan los distintos advertiser_id en hacer click.
